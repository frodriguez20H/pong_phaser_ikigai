...
module.exports = __webpack_require__(/*! /home/frodri/Cursos/Bootcamp 20H Ikigai/phaser-es6-webpack/src/main.js */333);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, window.innerWidth, window.innerHeight, _phaser2.default.CANVAS, 'content', null));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    key: 'init',
    value: function init() {
      this.stage.backgroundColor = '#9AD8ED';
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.onScore = new _phaser2.default.Signal();
      ...
      this.uKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.UP);
      this.dKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.DOWN);

      this.wKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.W);
      this.sKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.S);

      this.spaceKey = game.input.keyboard.addKey(_phaser2.default.Keyboard.SPACEBAR);

      game.input.keyboard.addKeyCapture([_phaser2.default.Keyboard.UP, _phaser2.default.Keyboard.DOWN, _phaser2.default.Keyboard.W, _phaser2.default.Keyboard.S, _phaser2.default.Keyboard.SPACEBAR]);

      var createSprite = function createSprite(x, y, width, height, key, parent) {
      ...
      var createRectangle = function createRectangle(x, y, width, height, color, parent) {
    ...
    value: function update() {
      ...
      var leftBounded = this.ball.x <= 40 + 20;
      var rightBounded = this.ball.x >= W - 20 - 40 - 40;

      var p1Hits = this.player1.y < this.ball.y + this.ball.height && this.player1.y + this.player1.height > this.ball.y;
      var p2Hits = this.player2.y < this.ball.y + this.ball.height && this.player2.y + this.player2.height > this.ball.y;
    ...
    key: 'setScore',
    value: function setScore(player) {
      if (player === 1) {
        this.player1Score++;
      } else {
        this.player2Score++;
    ...
    value: function prepareGame() {
      ...
      this.spaceKey.onDown.addOnce(function () {
        _this2.ballMoveX = Math.round(Math.random(1)) ? _this2.ballSpeed : -_this2.ballSpeed;
        _this2.ballMoveY = Math.round(Math.random(1)) ? _this2.ballSpeed : -_this2.ballSpeed;
      }, this);
    }
  }]);
